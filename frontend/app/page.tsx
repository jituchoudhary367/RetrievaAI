...
import { RetrievalDetailsPanel } from '../components/context/RetrievalDetailsPanel';
import { ConversationContextPanel } from '../components/context/ConversationContextPanel';
        ...
        <div className="w-80 flex-shrink-0 flex flex-col bg-muted/10 overflow-y-auto hidden lg:flex">
          <div className="flex-1 p-2 space-y-2">
            ...
            <RetrievalDetailsPanel 
              metadata={metadata}
              filters={[]} // Mocking filters since they are local to outgoing request
            />
