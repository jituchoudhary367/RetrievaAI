...
export default function AnalyticsPage() {
  return (
    <div className="flex h-full w-full bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 border-r border-border relative bg-background overflow-y-auto scrollbar-thin">
        <TopBar 
          title="Analytics"
      ...
      <div className="w-80 lg:w-[340px] flex-shrink-0 bg-[#0d1117] overflow-y-auto hidden md:flex flex-col">
         <AnalyticsRightPanel />
      </div>
