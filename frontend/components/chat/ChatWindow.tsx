    ...
    <div className="flex flex-col h-full bg-transparent">
      <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 scrollbar-thin">
        <div className="mx-auto flex max-w-3xl flex-col gap-6 pb-6">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center text-center animate-slide-up py-20 mt-10">
              ...
              return (
                <div key={i} className="flex flex-col gap-2">
                  ...
                  {isLastAssistant && !isStreaming && (
                    <SuggestedFollowUps onPick={(q) => onSendMessage(q, false)} />
                  )}
                </div>
              );
            })
      ...
      <div className="mx-auto w-full max-w-3xl pb-4 px-4 md:px-0 bg-transparent">
        {canChat ? (
          <ChatInput onSend={onSendMessage} onUpload={onUpload} disabled={isStreaming} />
        ) : (
