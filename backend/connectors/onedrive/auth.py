...
MICROSOFT_CLIENT_ID = os.environ.get("MICROSOFT_CLIENT_ID", "mock-ms-client-id")
MICROSOFT_CLIENT_SECRET = os.environ.get("MICROSOFT_CLIENT_SECRET", "mock-ms-client-secret")
MICROSOFT_REDIRECT_URI = os.environ.get("MICROSOFT_REDIRECT_URI", "http://localhost:8000/api/connectors/oauth/callback")
