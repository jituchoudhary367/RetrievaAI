...
def render_rag_prompt(
    ...
    citation_instruction = (
        "For every factual claim, include an inline citation in the form "
        "[source: <chunk_id>] where <chunk_id> is the identifier shown in the "
        "context below. If you cannot cite a claim, omit it."
